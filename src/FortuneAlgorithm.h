...
private:
    ...
    void removeArc(Arc* arc, Vertex* vertex);
    ...
    void setOrigin(Arc* left, Arc* right, Vertex* vertex);
    void setDestination(Arc* left, Arc* right, Vertex* vertex);
    void setPrevHalfEdge(HalfEdge* prev, HalfEdge* next);
